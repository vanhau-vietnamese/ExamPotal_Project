export default function DetailExamItem() {
  return (
    <div className="p-5">
      <div className="border border-gray bg-white m-3 rounded-md shadow-md w-80%">
        <h2 className="text-xl font-semibold ml-5 mt-5">Câu 1: Phan Ngọc Như Tranh là ai?</h2>
