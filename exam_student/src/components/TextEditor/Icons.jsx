...
export const HeadingThree = () => (
  <svg
    ...
    viewBox="0 0 24 24"
  >
    <path d="M4 12h8M4 18V6M12 18V6M17.5 10.5c1.7-1 3.5 0 3.5 1.5a2 2 0 01-2 2M17 17.5c2 1.5 4 .3 4-1.5a2 2 0 00-2-2"></path>
  </svg>
);
...
export const TextAlignLeft = () => (
  <svg
    ...
    className="w-4 h-4"
  >
    <path strokeLinecap="round" strokeLinejoin="round" d="M17 10H3M21 6H3M21 14H3M17 18H3" />
  </svg>
);
...
export const TextAlignCenter = () => (
  <svg
    ...
    className="w-4 h-4"
  >
    <path strokeLinecap="round" strokeLinejoin="round" d="M17 10H7M21 6H3M21 14H3M17 18H7" />
  </svg>
);
...
export const TextAlignRight = () => (
  <svg
    ...
    className="w-4 h-4"
  >
    <path strokeLinecap="round" strokeLinejoin="round" d="M7 10h14M3 6h18M3 14h18M7 18h14" />
  </svg>
);
